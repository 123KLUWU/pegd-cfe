...
<html lang="es" data-bs-theme="auto">
  <head>
    ...
    <meta name="description" content="@yield('meta_description', 'Plataforma PEGD-CFE')">
    <meta name="author" content="@yield('meta_author', 'Rubén Darío Chavarría Ramos / CFE')">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link rel="canonical" href="{{ url()->current() }}">

    <title>@yield('title', config('app.name', 'PEGD-CFE'))</title>
...
<div class="container-fluid">
  <div class="row">
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="sidebarMenuLabel">{{ config('app.name', 'PEGD-CFE') }}</h5>
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          ...
          <ul class="nav flex-column mb-auto">
            ...
            --}}
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 {{ request()->routeIs('admin.index') ? 'active' : '' }}" href="{{ route('admin.index') }}">
                <svg class="bi"><use xlink:href="#list"/></svg>
    ...
    {{-- Scripts por página / Modales globales --}}
    @stack('scripts')
    @stack('modals')
  </div>
</div>
